...
?>
    ...
    <div class="modal fade" id="smsToModal" role="dialog" style="width: 100%:">
        <div class="modal-dialog" style="max-width: 600px;">
            <!-- Modal content-->
            <div class="modal-content">
            <div class="modal-header">
                Send message to <?php echo $fetch['clientName'] ?>
            ...
            <div class="modal-body">
                ...
                <label>Body</label>
                <textarea class="form-control" style="height: 200px;" id="txtBody" name="txtBody">Good day <?php echo $fetch['clientName']?>, We are informing you that you have fire safety products expiring.
Please contact us now.

-Gibrosen Fire Safety Products</textarea>
            </div>
